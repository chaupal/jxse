...
public class SharedScheduledThreadPoolExecutor extends ScheduledThreadPoolExecutor {
    ...
    private final ScheduledExecutorService longTaskMonitorExecutor;
    ...
    public <V> ScheduledFuture<V> schedule(Callable<V> callable, long delay, TimeUnit unit) {
        return super.schedule((Callable<V>)new RunMetricsWrapper<>(longTaskMonitorExecutor, callable), delay, unit);
    }
    ...
    public <T> Future<T> submit(Callable<T> task) {
        return super.submit((Callable<T>)new RunMetricsWrapper<>(longTaskMonitorExecutor, task));
    }
